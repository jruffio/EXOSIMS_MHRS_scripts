...
if __name__ == "__main__":
    ...
    scriptfile_list = []
    output_filelist0 = []
    _output_filename0 = "/fast/jruffio/data/exosims/exosims_samples/20251022_output/20251022_MHRS_emccd_SNR_outputs_paper"
    output_filelist0.append(_output_filename0)
    # _output_filename0 = "/fast/jruffio/data/exosims/exosims_samples/20251022_output/20251022_MHRS_10xbetterEmccd_SNR_outputs_paper"
    # output_filelist0.append(_output_filename0)
    # _output_filename0 = "/fast/jruffio/data/exosims/exosims_samples/20251022_output/20251022_MHRS_nodetecnoise_SNR_outputs_paper"
    # output_filelist0.append(_output_filename0)
    # _output_filename0 = "/fast/jruffio/data/exosims/exosims_samples/20251022_output/20251022_MHRS_emccd_undersamp_SNR_outputs_paper"
    # output_filelist0.append(_output_filename0)
    detector_labels = ['EMCCD'] #,'Roman-analog & undersampled',"10x better detector","No detector noise"
